...
${KUBECTL} delete accesspackageresourcepackageassociation.identitygovernance.azuread.upbound.io \
  --all --ignore-not-found --timeout 10m

${KUBECTL} delete accesspackageresourcecatalogassociation.identitygovernance.azuread.upbound.io \
  --all --ignore-not-found --timeout 10m
