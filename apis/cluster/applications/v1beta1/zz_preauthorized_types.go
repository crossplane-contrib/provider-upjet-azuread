...
type PreAuthorizedInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	AuthorizedClientIDRef *v2.Reference `json:"authorizedClientIdRef,omitempty" tf:"-"`

	// Selector for a Application in applications to populate authorizedClientId.
	// +kubebuilder:validation:Optional
	AuthorizedClientIDSelector *v2.Selector `json:"authorizedClientIdSelector,omitempty" tf:"-"`
