...
type PrivilegedAccessGroupAssignmentScheduleObservation struct {
...
type PrivilegedAccessGroupAssignmentScheduleParameters struct {
...
type PrivilegedAccessGroupAssignmentScheduleSpec struct {
	...
	// autoscaler.
	InitProvider PrivilegedAccessGroupAssignmentScheduleInitParameters `json:"initProvider,omitempty"`
}
...
// PrivilegedAccessGroupAssignmentSchedule is the Schema for the PrivilegedAccessGroupAssignmentSchedules API.
...
type PrivilegedAccessGroupAssignmentSchedule struct {
	...
	Spec   PrivilegedAccessGroupAssignmentScheduleSpec   `json:"spec"`
	Status PrivilegedAccessGroupAssignmentScheduleStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// PrivilegedAccessGroupAssignmentScheduleList contains a list of PrivilegedAccessGroupAssignmentSchedules
type PrivilegedAccessGroupAssignmentScheduleList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []PrivilegedAccessGroupAssignmentSchedule `json:"items"`
}

// Repository type metadata.
var (
	PrivilegedAccessGroupAssignmentSchedule_Kind             = "PrivilegedAccessGroupAssignmentSchedule"
	PrivilegedAccessGroupAssignmentSchedule_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: PrivilegedAccessGroupAssignmentSchedule_Kind}.String()
	PrivilegedAccessGroupAssignmentSchedule_KindAPIVersion   = PrivilegedAccessGroupAssignmentSchedule_Kind + "." + CRDGroupVersion.String()
	PrivilegedAccessGroupAssignmentSchedule_GroupVersionKind = CRDGroupVersion.WithKind(PrivilegedAccessGroupAssignmentSchedule_Kind)
)

func init() {
	SchemeBuilder.Register(&PrivilegedAccessGroupAssignmentSchedule{}, &PrivilegedAccessGroupAssignmentScheduleList{})
}
