...
// ConvertTo converts this Invitation to the hub type.
func (tr *Invitation) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the Invitation type.
func (tr *Invitation) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
