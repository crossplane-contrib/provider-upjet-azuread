...
type MemberInitParameters struct {
	...
	AdministrativeUnitObjectIDRef *v2.Reference `json:"administrativeUnitObjectIdRef,omitempty" tf:"-"`

	// Selector for a Unit in administrativeunits to populate administrativeUnitObjectId.
	// +kubebuilder:validation:Optional
	AdministrativeUnitObjectIDSelector *v2.Selector `json:"administrativeUnitObjectIdSelector,omitempty" tf:"-"`
