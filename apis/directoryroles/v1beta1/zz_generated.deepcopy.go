...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RoleMember) DeepCopyInto(out *RoleMember) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RoleMember.
func (in *RoleMember) DeepCopy() *RoleMember {
	if in == nil {
		return nil
	}
	out := new(RoleMember)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *RoleMember) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RoleMemberList) DeepCopyInto(out *RoleMemberList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]RoleMember, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RoleMemberList.
func (in *RoleMemberList) DeepCopy() *RoleMemberList {
	if in == nil {
		return nil
	}
	out := new(RoleMemberList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *RoleMemberList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RoleMemberObservation) DeepCopyInto(out *RoleMemberObservation) {
	*out = *in
	if in.ID != nil {
		in, out := &in.ID, &out.ID
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RoleMemberObservation.
func (in *RoleMemberObservation) DeepCopy() *RoleMemberObservation {
	if in == nil {
		return nil
	}
	out := new(RoleMemberObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RoleMemberParameters) DeepCopyInto(out *RoleMemberParameters) {
	*out = *in
	...
	if in.RoleObjectID != nil {
		in, out := &in.RoleObjectID, &out.RoleObjectID
		*out = new(string)
		**out = **in
	}
	if in.RoleObjectIDRef != nil {
		in, out := &in.RoleObjectIDRef, &out.RoleObjectIDRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.RoleObjectIDSelector != nil {
		in, out := &in.RoleObjectIDSelector, &out.RoleObjectIDSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RoleMemberParameters.
func (in *RoleMemberParameters) DeepCopy() *RoleMemberParameters {
	if in == nil {
		return nil
	}
	out := new(RoleMemberParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RoleMemberSpec) DeepCopyInto(out *RoleMemberSpec) {
	*out = *in
	in.ResourceSpec.DeepCopyInto(&out.ResourceSpec)
	in.ForProvider.DeepCopyInto(&out.ForProvider)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RoleMemberSpec.
func (in *RoleMemberSpec) DeepCopy() *RoleMemberSpec {
	if in == nil {
		return nil
	}
	out := new(RoleMemberSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RoleMemberStatus) DeepCopyInto(out *RoleMemberStatus) {
	*out = *in
	in.ResourceStatus.DeepCopyInto(&out.ResourceStatus)
	in.AtProvider.DeepCopyInto(&out.AtProvider)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RoleMemberStatus.
func (in *RoleMemberStatus) DeepCopy() *RoleMemberStatus {
	if in == nil {
		return nil
	}
	out := new(RoleMemberStatus)
	in.DeepCopyInto(out)
	return out
}
