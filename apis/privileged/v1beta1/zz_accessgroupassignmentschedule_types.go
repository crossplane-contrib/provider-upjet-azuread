...
type AccessGroupAssignmentScheduleInitParameters struct {
...
type AccessGroupAssignmentScheduleObservation struct {
...
type AccessGroupAssignmentScheduleParameters struct {
...
// AccessGroupAssignmentScheduleSpec defines the desired state of AccessGroupAssignmentSchedule
type AccessGroupAssignmentScheduleSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     AccessGroupAssignmentScheduleParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider AccessGroupAssignmentScheduleInitParameters `json:"initProvider,omitempty"`
}

// AccessGroupAssignmentScheduleStatus defines the observed state of AccessGroupAssignmentSchedule.
type AccessGroupAssignmentScheduleStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        AccessGroupAssignmentScheduleObservation `json:"atProvider,omitempty"`
}
...
// AccessGroupAssignmentSchedule is the Schema for the AccessGroupAssignmentSchedules API.
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,azuread}
type AccessGroupAssignmentSchedule struct {
	...
	Spec   AccessGroupAssignmentScheduleSpec   `json:"spec"`
	Status AccessGroupAssignmentScheduleStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// AccessGroupAssignmentScheduleList contains a list of AccessGroupAssignmentSchedules
type AccessGroupAssignmentScheduleList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []AccessGroupAssignmentSchedule `json:"items"`
}

// Repository type metadata.
var (
	AccessGroupAssignmentSchedule_Kind             = "AccessGroupAssignmentSchedule"
	AccessGroupAssignmentSchedule_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: AccessGroupAssignmentSchedule_Kind}.String()
	AccessGroupAssignmentSchedule_KindAPIVersion   = AccessGroupAssignmentSchedule_Kind + "." + CRDGroupVersion.String()
	AccessGroupAssignmentSchedule_GroupVersionKind = CRDGroupVersion.WithKind(AccessGroupAssignmentSchedule_Kind)
)

func init() {
	SchemeBuilder.Register(&AccessGroupAssignmentSchedule{}, &AccessGroupAssignmentScheduleList{})
}
