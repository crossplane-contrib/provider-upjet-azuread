...
type RoleAssignment struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.appRoleId) || has(self.initProvider.appRoleId)",message="appRoleId is a required parameter"
