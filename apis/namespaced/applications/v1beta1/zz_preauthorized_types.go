...
type PreAuthorizedInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	ApplicationObjectIDRef *v1.NamespacedReference `json:"applicationObjectIdRef,omitempty" tf:"-"`

	// Selector for a Application in applications to populate applicationObjectId.
	// +kubebuilder:validation:Optional
	ApplicationObjectIDSelector *v1.NamespacedSelector `json:"applicationObjectIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	AuthorizedAppIDRef *v1.NamespacedReference `json:"authorizedAppIdRef,omitempty" tf:"-"`

	// Selector for a Application in applications to populate authorizedAppId.
	// +kubebuilder:validation:Optional
	AuthorizedAppIDSelector *v1.NamespacedSelector `json:"authorizedAppIdSelector,omitempty" tf:"-"`
