...
func (in *PermissionGrantInitParameters) DeepCopyInto(out *PermissionGrantInitParameters) {
	*out = *in
	...
	if in.UserObjectIDRef != nil {
		in, out := &in.UserObjectIDRef, &out.UserObjectIDRef
		*out = new(v1.NamespacedReference)
		(*in).DeepCopyInto(*out)
	}
	if in.UserObjectIDSelector != nil {
		in, out := &in.UserObjectIDSelector, &out.UserObjectIDSelector
		*out = new(v1.NamespacedSelector)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *PermissionGrantInitParameters) DeepCopy() *PermissionGrantInitParameters {
	...
	out := new(PermissionGrantInitParameters)
	in.DeepCopyInto(out)
	return out
}
