...
type PrivilegedAccessGroupEligibilityScheduleInitParameters struct {
...
type PrivilegedAccessGroupEligibilityScheduleObservation struct {
...
type PrivilegedAccessGroupEligibilityScheduleParameters struct {
...
type PrivilegedAccessGroupEligibilityScheduleSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            PrivilegedAccessGroupEligibilityScheduleParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider PrivilegedAccessGroupEligibilityScheduleInitParameters `json:"initProvider,omitempty"`
}

// PrivilegedAccessGroupEligibilityScheduleStatus defines the observed state of PrivilegedAccessGroupEligibilitySchedule.
type PrivilegedAccessGroupEligibilityScheduleStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        PrivilegedAccessGroupEligibilityScheduleObservation `json:"atProvider,omitempty"`
}
...
type PrivilegedAccessGroupEligibilitySchedule struct {
	...
	Spec   PrivilegedAccessGroupEligibilityScheduleSpec   `json:"spec"`
	Status PrivilegedAccessGroupEligibilityScheduleStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// PrivilegedAccessGroupEligibilityScheduleList contains a list of PrivilegedAccessGroupEligibilitySchedules
type PrivilegedAccessGroupEligibilityScheduleList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []PrivilegedAccessGroupEligibilitySchedule `json:"items"`
}

// Repository type metadata.
var (
	PrivilegedAccessGroupEligibilitySchedule_Kind             = "PrivilegedAccessGroupEligibilitySchedule"
	PrivilegedAccessGroupEligibilitySchedule_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: PrivilegedAccessGroupEligibilitySchedule_Kind}.String()
	PrivilegedAccessGroupEligibilitySchedule_KindAPIVersion   = PrivilegedAccessGroupEligibilitySchedule_Kind + "." + CRDGroupVersion.String()
	PrivilegedAccessGroupEligibilitySchedule_GroupVersionKind = CRDGroupVersion.WithKind(PrivilegedAccessGroupEligibilitySchedule_Kind)
)

func init() {
	SchemeBuilder.Register(&PrivilegedAccessGroupEligibilitySchedule{}, &PrivilegedAccessGroupEligibilityScheduleList{})
}
