...
import (
	...
	v1beta1 "github.com/upbound/provider-azuread/v2/apis/namespaced/conditionalaccess/v1beta1"
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	eventHandler := handler.NewEventHandler(handler.WithDefaultRateLimiter(rl), handler.WithLogger(o.Logger.WithValues("gvk", v1beta1.Location_GroupVersionKind)))
