...
import (
	...
	location "github.com/upbound/provider-azuread/v2/internal/controller/cluster/conditionalaccess/location"
	customdirectoryrole "github.com/upbound/provider-azuread/v2/internal/controller/cluster/directoryroles/customdirectoryrole"
	role "github.com/upbound/provider-azuread/v2/internal/controller/cluster/directoryroles/role"
	roleassignmentdirectoryroles "github.com/upbound/provider-azuread/v2/internal/controller/cluster/directoryroles/roleassignment"
	...
	claimsmappingpolicy "github.com/upbound/provider-azuread/v2/internal/controller/cluster/policies/claimsmappingpolicy"
	grouprolemanagementpolicy "github.com/upbound/provider-azuread/v2/internal/controller/cluster/policies/grouprolemanagementpolicy"
	providerconfig "github.com/upbound/provider-azuread/v2/internal/controller/cluster/providerconfig"
	permissiongrant "github.com/upbound/provider-azuread/v2/internal/controller/cluster/serviceprincipaldelegated/permissiongrant"
	certificateserviceprincipals "github.com/upbound/provider-azuread/v2/internal/controller/cluster/serviceprincipals/certificate"
	claimsmappingpolicyassignment "github.com/upbound/provider-azuread/v2/internal/controller/cluster/serviceprincipals/claimsmappingpolicyassignment"
	passwordserviceprincipals "github.com/upbound/provider-azuread/v2/internal/controller/cluster/serviceprincipals/password"
	principal "github.com/upbound/provider-azuread/v2/internal/controller/cluster/serviceprincipals/principal"
	tokensigningcertificate "github.com/upbound/provider-azuread/v2/internal/controller/cluster/serviceprincipals/tokensigningcertificate"
	job "github.com/upbound/provider-azuread/v2/internal/controller/cluster/synchronization/job"
	secret "github.com/upbound/provider-azuread/v2/internal/controller/cluster/synchronization/secret"
