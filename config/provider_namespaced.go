...
import (
	...
	"github.com/upbound/provider-azuread/v2/config/namespaced/conditionalaccess"
	"github.com/upbound/provider-azuread/v2/config/namespaced/directoryroles"
	"github.com/upbound/provider-azuread/v2/config/namespaced/groups"
	"github.com/upbound/provider-azuread/v2/config/namespaced/identitygovernance"
	"github.com/upbound/provider-azuread/v2/config/namespaced/invitations"
	"github.com/upbound/provider-azuread/v2/config/namespaced/policies"
	"github.com/upbound/provider-azuread/v2/config/namespaced/serviceprincipaldelegated"
